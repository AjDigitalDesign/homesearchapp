    ...
    <div class="home">
        ...
        <div class="home_slider_container">
            <div class="owl-carousel owl-theme home_slider">
                ...
                <!-- Slide -->
                <div class="slide">
                    <div class="background_image" style="background-image:url(/assets/img/index.jpg)"></div>
            ...
            <div class="row featured_row">
                    ...
                    <div class="listing">
                        <div class="listing_image">
                            <div class="listing_image_container">
                                <img src="/assets/img/listing_1.jpg" alt="">
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="listing">
                        <div class="listing_image">
                            <div class="listing_image_container">
                                <img src="/assets/img/listing_2.jpg" alt="">
                            </div>
                            <div class="tags d-flex flex-row align-items-start justify-content-start flex-wrap">
                                <div class="tag tag_house"><a href="listings.html">house</a></div>
                ...
                <div class="col-lg-4">
                    <div class="listing">
                        <div class="listing_image">
                            <div class="listing_image_container">
                                <img src="/assets/img/listing_3.jpg" alt="">
                            </div>
                            <div class="tags d-flex flex-row align-items-start justify-content-start flex-wrap">
                                <div class="tag tag_house"><a href="listings.html">house</a></div>
                                <div class="tag tag_sale"><a href="listings.html">for sale</a></div>
    ...
    <div class="hot">
        <div class="container">
            ...
            <div class="row hot_row row-eq-height">
                ...
                <div class="col-lg-6">
                    <div class="hot_image">
                        <div class="background_image" style="background-image:url(/assets/img/hot.jpg)"></div>
                        <div class="tags d-flex flex-row align-items-start justify-content-start flex-wrap">
                            <div class="tag tag_house"><a href="listings.html">house</a></div>
                            <div class="tag tag_sale"><a href="listings.html">for sale</a></div>
                        </div>
                    ...
                    <div class="hot_content">
                        <div class="hot_deal">
                            ...
                            <div class="prop_agent d-flex flex-row align-items-center justify-content-start">
                                <div class="prop_agent_image"><img src="/assets/img/agent_1.jpg" alt=""></div>
                        ...
                        <div class="prop_info">
                            <ul class="d-flex flex-row align-items-center justify-content-start flex-wrap">
                                <li class="d-flex flex-row align-items-center justify-content-start">
                                    <img src="/assets/img/icon_2_large.png" alt="">
                                    <div>
                                        <div>1234</div>
                                        <div>sq ft</div>
                                    </div>
                                ...
                                <li class="d-flex flex-row align-items-center justify-content-start">
                                    <img src="/assets/img/icon_3_large.png" alt="">
                                    <div>
                                        <div>2</div>
                                        <div>baths</div>
                                    </div>
                                ...
                                <li class="d-flex flex-row align-items-center justify-content-start">
                                    <img src="/assets/img/icon_4_large.png" alt="">
                                    <div>
                                        <div>5</div>
                                        <div>beds</div>
                                    </div>
                                ...
                                <li class="d-flex flex-row align-items-center justify-content-start">
                                    <img src="/assets/img/icon_5_large.png" alt="">
                                    <div>
                                        <div>2</div>
                                        <div>garages</div>
                                    </div>
            ...
            <div class="row row-eq-height">
                ...
                <div class="col-xl-6">
                    <div class="testimonials_image">
                        <div class="background_image" style="background-image:url(/assets/img/testimonials.jpg)"></div>
